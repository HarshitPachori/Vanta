...
- Delivers curated digest emails from senders you choose
...
We request only the minimum permissions required. You may revoke access at any time from your [Google Account permissions](https://myaccount.google.com/permissions).
...
- Attempt to reverse engineer, decompile, or access systems outside your account
...
THE SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. WE DO NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, ERROR-FREE, OR THAT ALL UNSUBSCRIBE REQUESTS WILL BE SUCCESSFULLY PROCESSED.
...
You may delete your account at any time from account settings. We may suspend or terminate your access if you violate these Terms. Upon termination, all your data is permanently deleted per our Privacy Policy.

---

## 13. Changes to Terms

We may update these Terms as the Service evolves. We will notify you of material changes via email. Continued use of the Service after the effective date constitutes acceptance of the updated Terms.
