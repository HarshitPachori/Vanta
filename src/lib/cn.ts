...
// Icon square
export const iconSquare = (color: string, size = "w-8 h-8 rounded-lg") => cn(
...
// Table
export const tableHeaderCell = "px-4 py-2.5 text-[11px] font-mono font-medium text-(--color-text-muted) uppercase tracking-[0.06em] text-left whitespace-nowrap"
