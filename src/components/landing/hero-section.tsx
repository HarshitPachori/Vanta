...
export default function HeroSection() {
  return (
    <section
      ...
      className="relative min-h-dvh flex items-center px-5 pt-20 pb-16 overflow-hidden"
    >
      {/* Amber bloom */}
      <div
        aria-hidden="true"
      ...
      >
        ...
        />
        <path
          d="M0,800 C400,650 800,850 1200,600 C1320,530 1400,480 1440,450"
          fill="none"
          stroke="#F97316"
          strokeWidth="0.75"
        />
      ...
      <div className="relative z-10 mx-auto max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <span className="text-xs font-mono text-(--color-accent) uppercase tracking-[0.12em]">
              Early access open
            </span>
          </motion.div>
          ...
          >
            Your inbox,{" "}
            <em className="not-italic text-gradient">finally quiet.</em>
          </motion.h1>
          ...
          >
            <span className="font-display font-black text-(--color-accent) text-lg leading-none tracking-tight">
              12,847
            </span>
        ...
        >
          <Suspense
            fallback={
              <div className="h-105 rounded-2xl bg-(--color-surface) border border-(--color-border) animate-pulse" />
            }
          >
            <HeroAnimation />
          </Suspense>
