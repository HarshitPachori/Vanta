        ...
        <section aria-labelledby="account-heading" className={cn(cardSection, " rounded-xl p-6")}>
          ...
          <div className="flex items-center gap-4">
            {user.avatarUrl ? (
              ...
              <span
                aria-hidden="true"
                className={cn(glassAvatar, "h-12 w-12 rounded-full bg-(--color-accent-muted) border border-(--color-accent-border) flex items-center justify-center text-sm font-bold font-display text-(--color-accent)")}>
