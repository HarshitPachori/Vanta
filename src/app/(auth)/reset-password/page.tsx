	...
	return (
		<article className="w-full max-w-sm">
			<header className="text-center mb-8">
				<h1 className="text-2xl font-display font-bold text-(--color-text-primary) tracking-tight">Set new password</h1>
				<p className="mt-2 text-sm text-(--color-text-secondary)">Choose a strong password for your account.</p>
			</header>
